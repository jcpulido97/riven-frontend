 ...
 */
export type DownloaderUserInfo = {
    /**
     * Service
     */
...
export type DownloaderUserInfoResponse = {
     ...
     * Services
     */
    services: Array<DownloaderUserInfo>;
};
...
export type DownloadersModel = {
    ...
    /**
     * AllDebrid downloader configuration
     */
 ...
 * ItemAliasesResponse
 */
export type ItemAliasesResponse = {
    /**
     * Aliases
     */
    aliases: {
...
export type JackettConfig = {
     ...
     * Timeout in seconds for parallel infohash fetching from URLs
     */
...
export type DownloadUserInfoData = {
    body?: never;
    path?: never;
    query?: never;
...
export type DownloadUserInfoErrors = {
    /**
     * Not found
     */
    404: unknown;
...
export type DownloadUserInfoResponses = {
    /**
     * Successful Response
     */
    200: DownloaderUserInfoResponse;
};

export type DownloadUserInfoResponse = DownloadUserInfoResponses[keyof DownloadUserInfoResponses];
